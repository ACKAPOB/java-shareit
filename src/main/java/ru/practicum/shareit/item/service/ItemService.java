...
public interface ItemService {
    ...
    List<ItemDtoLastNext> getAllItemsOwner (Optional<Long> idUser, Optional<Integer> from, Optional<Integer> size);
    ...
    ItemDtoLastNext getItemById(Optional<Long> idUser, Optional<Long> id);
