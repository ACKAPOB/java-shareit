...
public class BookingRepositoryTest {
    ...
    private final ItemRequest itemRequest = new ItemRequest(1L,"description", user1,
            localDateTime.minusMonths(2));
    private final Item item = new Item(1L, "item","desc", false, user2, itemRequest);
    private final Booking booking = new Booking(1L, localDateTime, localDateTime.plusMonths(2), item, user2, Status.REJECTED);
